...
import uk.co.zoneofavoidance.planner.config.Constants;
import uk.co.zoneofavoidance.planner.domain.Authority;
import uk.co.zoneofavoidance.planner.domain.User;
import uk.co.zoneofavoidance.planner.repository.AuthorityRepository;
import uk.co.zoneofavoidance.planner.repository.UserRepository;
import uk.co.zoneofavoidance.planner.security.AuthoritiesConstants;
import uk.co.zoneofavoidance.planner.service.MailService;
import uk.co.zoneofavoidance.planner.service.UserService;
import uk.co.zoneofavoidance.planner.service.dto.PasswordChangeDTO;
import uk.co.zoneofavoidance.planner.service.dto.UserDTO;
import uk.co.zoneofavoidance.planner.web.rest.errors.ExceptionTranslator;
import uk.co.zoneofavoidance.planner.web.rest.vm.KeyAndPasswordVM;
import uk.co.zoneofavoidance.planner.web.rest.vm.ManagedUserVM;
