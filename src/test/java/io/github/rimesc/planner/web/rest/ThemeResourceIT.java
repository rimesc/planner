...
public class ThemeResourceIT {
    ...
    @Test
    @Transactional
    public void getAllThemesByShortNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        themeRepository.saveAndFlush(theme);

        // Get all the themeList where shortName not equals to DEFAULT_SHORT_NAME
        defaultThemeShouldNotBeFound("shortName.notEquals=" + DEFAULT_SHORT_NAME);

        // Get all the themeList where shortName not equals to UPDATED_SHORT_NAME
        defaultThemeShouldBeFound("shortName.notEquals=" + UPDATED_SHORT_NAME);
    }
    ...
    public void getAllThemesByShortNameIsNullOrNotNull() throws Exception {
        ...
        defaultThemeShouldNotBeFound("shortName.specified=false");
                ...
                @Test
    @Transactional
    public void getAllThemesByShortNameContainsSomething() throws Exception {
        // Initialize the database
        themeRepository.saveAndFlush(theme);

        // Get all the themeList where shortName contains DEFAULT_SHORT_NAME
        defaultThemeShouldBeFound("shortName.contains=" + DEFAULT_SHORT_NAME);

        // Get all the themeList where shortName contains UPDATED_SHORT_NAME
        defaultThemeShouldNotBeFound("shortName.contains=" + UPDATED_SHORT_NAME);
    }

    @Test
    @Transactional
    public void getAllThemesByShortNameNotContainsSomething() throws Exception {
        // Initialize the database
        themeRepository.saveAndFlush(theme);

        // Get all the themeList where shortName does not contain DEFAULT_SHORT_NAME
        defaultThemeShouldNotBeFound("shortName.doesNotContain=" + DEFAULT_SHORT_NAME);

        // Get all the themeList where shortName does not contain UPDATED_SHORT_NAME
        defaultThemeShouldBeFound("shortName.doesNotContain=" + UPDATED_SHORT_NAME);
    }
    ...
    public void getAllThemesByCreatedIsNotEqualToSomething() throws Exception {
        ...
        // Get all the themeList where created not equals to DEFAULT_CREATED
        defaultThemeShouldNotBeFound("created.notEquals=" + DEFAULT_CREATED);

        // Get all the themeList where created not equals to UPDATED_CREATED
        defaultThemeShouldBeFound("created.notEquals=" + UPDATED_CREATED);
    }
