...
describe('Task e2e test', () => {
  ...
  /* it('should create and save Tasks', async () => {
    ...
    expect(await taskUpdatePage.getCreatedInput()).to.contain('2001-01-01T02:30', 'Expected created value to be equals to 2000-12-31');
    expect(await taskUpdatePage.getCompletedInput()).to.contain('2001-01-01T02:30', 'Expected completed value to be equals to 2000-12-31');
