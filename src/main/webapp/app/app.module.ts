...
import { PlannerCoreModule } from 'app/core';
import { PlannerAppRoutingModule } from './app-routing.module';
import { PlannerHomeModule } from './home/home.module';
import { PlannerAccountModule } from './account/account.module';
import { PlannerEntityModule } from './entities/entity.module';
import * as moment from 'moment';
// jhipster-needle-angular-add-module-import JHipster will add new module here
import { JhiMainComponent, NavbarComponent, PageRibbonComponent, ActiveMenuDirective, ErrorComponent } from './layouts';
...
@NgModule({
    imports: [
        ...
        PlannerSharedModule.forRoot(),
        PlannerCoreModule,
        PlannerHomeModule,
        PlannerAccountModule,
